...
NEW_EVENTS = [
    ...
    ("mayia-boxyard-saturdaze-2026", base_event(
        ...
        sources=[
            source("Boxyard RTP official event", "https://boxyard.rtp.org/events/saturdaze-wattyandmayia-102026-295-435-108/", "official_event", 112),
            source("MAYIA official calendar", "https://mayiawarren.org/go/bandsintown/21578/event/108885203", "artist_calendar", 100),
        ],
    ...
    ("mayia-nc-state-fair-2026", base_event(
        ...
        authority="official_event",
        sources=[
            source("North Carolina State Fair official site", "https://www.ncagr.gov/divisions/ncstatefair", "official_event", 112),
            source("MAYIA official calendar", "https://mayiawarren.org/go/bandsintown/21578/event/108885151", "artist_calendar", 100),
        ],
